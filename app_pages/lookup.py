...
Zip code -> live election lookup page. Collects a US zip code, searches for
the next mayoral, county, and U.S. House elections via election_lookup.py,
and links to the issues questionnaire under each race.
"""
    ...
    for office in ("mayor", "county", "us_house"):
        ...
        with st.expander(OFFICE_LABELS[office], expanded=True):
            ...
            st.page_link(
                ...
                label="Take the issues questionnaire",
                icon=":material/checklist:",
                query_params={"from_office": office, "zip": result.zipcode},
            )
