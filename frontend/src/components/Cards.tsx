    ...
    >
      ...
      <div className="p-5">
        ...
        <p className="text-sm text-navy/65 leading-relaxed line-clamp-3 mb-3.5">
          {summary ??
            (researching
              ? 'Researching this candidate’s positions…'
              : 'No documented position found for this candidate.')}
        </p>
        ...
        <div className="flex flex-wrap gap-1.5 mb-4">
          {issueTags.length > 0 ? (
            ...
            <span className="text-xs text-civic italic flex items-center gap-1.5">
        ...
        <div className="pt-3.5 border-t border-border flex items-end justify-between gap-3">
          <div>
            ...
            {researching ? (
              <span className="text-[11px] text-civic font-mono">Researching…</span>
            ) : (
